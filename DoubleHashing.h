...
public:
    DHashMap(int capacity);                                  // constructor
...
public:
    ...
    public:
        ...
        friend class DHashMap;                              // give HashMap access
    };
};

template <typename K, typename V>                           // constructor
DHashMap<K,V>::DHashMap(int capacity) : n(0), B(capacity) { }

template <typename K, typename V>                           // number of entries
int DHashMap<K,V>::size() const { return n; }

template <typename K, typename V>                           // is the map empty?
bool DHashMap<K,V>::empty() const { return size() == 0; }

template <typename K, typename V>                           // iterator to end
typename DHashMap<K,V>::Iterator DHashMap<K,V>::end()
{ return Iterator(B, B.end()); }

template <typename K, typename V>                           // iterator to front
typename DHashMap<K,V>::Iterator DHashMap<K,V>::begin() {
...
typename DHashMap<K,V>::Iterator DHashMap<K,V>::find(const K& k) {
...
typename DHashMap<K,V>::Iterator DHashMap<K,V>::inserter(const Iterator& p, const Entry& e) {
...
typename DHashMap<K,V>::Iterator DHashMap<K,V>::put(const K& k, const V& v) {
...
bool DHashMap<K,V>::Iterator::operator==(const Iterator& p) const {
...
typename DHashMap<K,V>::Iterator& DHashMap<K,V>::Iterator::operator++() {
...
typename DHashMap<K,V>::Entry& DHashMap<K,V>::Iterator::operator*() const
{ return *ent; }
